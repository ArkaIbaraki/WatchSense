                    ...
                    <div class="bg-ash rounded-lg p-6 border border-off-black">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <p class="text-lg font-medium text-platinum">
                                    {{ Auth::user()->created_at->format('M d, Y') }}</p>
                            </div>
                            @if (Auth::user()->is_admin)
                                <div class="pt-4">
                                    <span
                                        class="inline-block bg-platinum text-cod-gray px-3 py-1 rounded-full text-sm font-semibold">
                                        Administrator
                                    </span>
                                </div>
                            @endif
                        ...
                        <div class="bg-ash rounded-lg p-6 border border-off-black">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-3xl font-bold text-platinum">
